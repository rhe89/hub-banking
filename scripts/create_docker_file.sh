...
echo RUN dotnet nuget add source https://rhe89.pkgs.visualstudio.com/_packaging/rhe89/nuget/v3/index.json -n github -u rhe89 -p "$nuget_access_token" --store-password-in-clear-text >> Dockerfile
