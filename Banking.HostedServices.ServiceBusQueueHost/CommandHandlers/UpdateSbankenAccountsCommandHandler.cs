...
public interface IUpdateBankingAccountsCommandHandler
{
    Task UpdateAccounts();
}
    
public class UpdateBankingAccountsCommandHandler : IUpdateBankingAccountsCommandHandler
{
    private readonly ISbankenConnector _sbankenConnector;
    private readonly IHubDbRepository _dbRepository;
    private readonly ILogger<UpdateBankingAccountsCommandHandler> _logger;

    public UpdateBankingAccountsCommandHandler(ILogger<UpdateBankingAccountsCommandHandler> logger,
