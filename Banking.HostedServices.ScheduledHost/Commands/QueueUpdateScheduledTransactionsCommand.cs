...
public class QueueUpdateScheduledTransactionsCommand : ScheduledCommand
{
    private readonly IMessageSender _messageSender;

    public QueueUpdateScheduledTransactionsCommand(ICommandConfigurationProvider commandConfigurationProvider,
