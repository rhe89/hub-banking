...
public class QueueUpdateAccountBalancesForNewMonthCommand : ScheduledCommand
{
    private readonly IMessageSender _messageSender;

    public QueueUpdateAccountBalancesForNewMonthCommand(
    ...
    {
        await _messageSender.AddToQueue(QueueNames.UpdateAccountBalancesForNewMonth);
    }
}