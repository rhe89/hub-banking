...
public class QueueUpdateBankingTransactionsCommand : ScheduledCommand
{
    private readonly IMessageSender _messageSender;

    public QueueUpdateBankingTransactionsCommand(ICommandConfigurationProvider commandConfigurationProvider,
