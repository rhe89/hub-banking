...
public class QueueUpdateRecurringTransactionsCommand : ScheduledCommand
{
    private readonly IMessageSender _messageSender;

    public QueueUpdateRecurringTransactionsCommand(ICommandConfigurationProvider commandConfigurationProvider,
    ...
    {
        await _messageSender.AddToQueue(QueueNames.UpdateRecurringTransactions);
    }
}